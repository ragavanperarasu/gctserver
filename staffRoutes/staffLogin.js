...
router.post('/stafflogin', async (req, res, next) => {
    ...
    const loginData = await saffLoginColl.findOne({mail:mail,pin:pin})
    ...
    if(loginData == null){
        ...
        if(dept === 'Civil Engineering'){
            staffDetail = await civilStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Mechanical Engineering'){
            staffDetail = await mechStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Electrical And Electronics Engineering'){
            staffDetail = await eeeStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Electronics And Communication Engineering'){
            staffDetail = await eceStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Production Engineering'){
            staffDetail = await prodStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Electronics And Instrumentation Engineering'){
            staffDetail = await eandiStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Computer Science Engineering'){
            staffDetail = await cseStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Information Technology'){
            staffDetail = await itStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Industrial Bio Technology'){
            staffDetail = await ibtStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Mathematics'){
            staffDetail = await mathsStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Physics'){
            staffDetail = await physicsStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Chemistry'){
            staffDetail = await chemStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'English'){
            staffDetail = await englishStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Physical Education'){
            staffDetail = await phyeduStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
        else if(dept === 'Science-Humanities'){
            staffDetail = await scihumStaffColl.findOne({mail:mail})
            res.send(staffDetail)
        }
    }
})
